...
export NUCLIO_PYTHON_WRAPPER_PATH=$CURRENT_DIR/test/rtsp_audio-webhook/_nuclio_wrapper.py
echo "NUCLIO_PYTHON_WRAPPER_PATH: $NUCLIO_PYTHON_WRAPPER_PATH"

go run ./cmd/processor --config=${CURRENT_DIR}/test/rtsp_audio-webhook/rtsp-processor.yaml
